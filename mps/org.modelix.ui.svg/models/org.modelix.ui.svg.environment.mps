...
<model ref="r:ad9b9e36-6a2e-49cf-96d6-a1b4ef7befcd(org.modelix.ui.svg.environment)">
  ...
  <node concept="312cEu" id="48Vb4Zfw6iN">
    ...
    <node concept="3clFb_" id="48Vb4ZfwiX1" role="jymVt">
      ...
      <node concept="3clFbS" id="48Vb4ZfwiX5" role="3clF47">
        <node concept="3J1_TO" id="48Vb4Zfwlu4" role="3cqZAp">
          <node concept="3clFbS" id="48Vb4Zfwlu6" role="1zxBo7">
          ...
          <node concept="3uVAMA" id="48Vb4Zfwlu7" role="1zxBo5">
            <node concept="XOnhg" id="48Vb4Zfwlu9" role="1zc67B">
              <property role="3TUv4t" value="false" />
              <property role="TrG5h" value="ex" />
              <node concept="nSUau" id="4fiQV6QTu_k" role="1tU5fm">
                <node concept="3uibUv" id="48Vb4ZfwlIH" role="nSUat">
                  <ref role="3uigEE" to="guwi:~IOException" resolve="IOException" />
                </node>
              </node>
            </node>
            <node concept="3clFbS" id="48Vb4Zfwlud" role="1zc67A" />
          </node>
        </node>
      </node>
    </node>
