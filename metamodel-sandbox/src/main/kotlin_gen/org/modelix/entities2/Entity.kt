...
public interface IC_Entity : IConceptWrapper, IC_INamedConcept {
  public val properties: IChildLink
}

public open class CW_Entity : CW_INamedConcept(), IC_Entity {
  public override val properties: IChildLink = C_Entity.properties
}

public interface IN_Entity : IN_INamedConcept {
  public val properties: ChildrenAccessor<N_Property>
}

public open class N_Entity(
  node: INode,
) : N_INamedConcept(node), IN_Entity {
  ...
  public override val properties: ChildrenAccessor<N_Property> = ChildrenAccessor(node,
      "properties", org.modelix.entities2.L_org_modelix_entities2.Property, N_Property::class)
}
