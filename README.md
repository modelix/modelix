[![Build Status](https://build.mbeddr.com/app/rest/builds/buildType:(id:modelix_ModelixBuild)/statusIcon)](https://build.mbeddr.com/buildConfiguration/modelix_ModelixBuild?branch=%3Cdefault%3E&mode=builds) 
