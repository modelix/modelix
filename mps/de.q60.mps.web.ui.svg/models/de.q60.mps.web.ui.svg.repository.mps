    ...
    <node concept="3clFb_" id="48Vb4ZfxEyZ" role="jymVt">
      ...
      <node concept="3clFbS" id="48Vb4ZfxEz3" role="3clF47">
        ...
        <node concept="3SKdUt" id="6DlEk$NPZeS" role="3cqZAp">
          <node concept="3SKdUq" id="6DlEk$NPZeU" role="3SKWNk">
            <property role="3SKdUp" value="performance optimization: hash the original file first. Then we don't have to copy existing files." />
          </node>
        </node>
