...
public class CloudIcons {
  ...
  public static final Icon REPOSITORY_ICON = new ShadowIcon("R", 14, 3.0f, 13.0f, Color.YELLOW, Color.BLACK);
  public static final Icon TREE_ICON = new ShadowIcon("T", 14, 3.0f, 13.0f, Color.YELLOW, Color.BLACK);
  public static final Icon BRANCH_ICON = new ShadowIcon("B", 14, 3.0f, 13.0f, Color.YELLOW, Color.BLACK);
